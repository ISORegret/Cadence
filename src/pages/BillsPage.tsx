      ...
      >
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <label className="block sm:col-span-2">
            ...
            <select
              name="payFrom"
              defaultValue={editing?.payFrom ?? 'checking'}
              className="select-field mt-1 w-full"
            >
